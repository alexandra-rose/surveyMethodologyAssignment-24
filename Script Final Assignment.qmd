...
As it was taking too much time, I found this why online to do it with cluster
...
## Correlation between the significant numeric variables (this does not work)
...
target_columns <- c("qc19", "qc20") # we pick 2 target variables because we are interested to see the correlation of th
