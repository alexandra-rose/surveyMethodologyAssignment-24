...
This is the best model so far, we an Accuracy of 74.89%, Sensitivity of 74.70% and a Specificity of 75.01%
...
```{r}
rocObj <- roc(response = testing$binary_qc19 ~ nnProb[,"Yes"])
plot(rocObj, col="red", print.thres = TRUE)
