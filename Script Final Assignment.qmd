...
df_descriptive <- data_cleaning_5
...
complete_data <- data_cleaning_5 |> 
  ...
  select(-c(qa1:qb9_12)) |> 
  mutate_if(is.character, as.numeric) # why this??

target_columns <- c("qc19", "qc20") # why are two target variables?? Sofi
...
I changed the code and for me this works.
