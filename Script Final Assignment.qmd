...
### Interpretation of the best model features
...
The selected predictive model for our international analysis is Gradient Boosting (GB), which has consistently outperformed all other models in terms of accuracy, except for the case of the Random Forest (RF) . However, RF has really unbalanced Sensitivity and Specificity rates.
