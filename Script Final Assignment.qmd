...
data_cleaning_4$binary_qc19 <- ifelse(data_cleaning_4$qc19 == 1, 1, ifelse(data_cleaning_4$qc19 == 2, 2, NA))

# binary_qc19 is our binary variable with 1 for Yes, 0 for No, and NA for Don't know
summary(data_cleaning_4$binary_qc19)
...
# write.csv(data_extra_by_Country, "data_extra_by_Country.csv", row.names = FALSE)
```
